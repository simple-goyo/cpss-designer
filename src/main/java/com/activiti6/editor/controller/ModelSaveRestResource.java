...
public class ModelSaveRestResource implements ModelDataJsonConstants {
  ...
  * */
  ...
  @ApiImplicitParams({
      ...
      @ApiImplicitParam(name = "json_xml", value = "建模工程的xml文档", dataType = "String", paramType = "body", required = true),
      @ApiImplicitParam(name = "svg_xml", value = "建模工程的svg结构", dataType = "String", paramType = "body", required = true)
  })
