// URL: https://beta.observablehq.com/@mbostock/d3-zoomable-sunburst
...
const m0 = {
    id: "86ddbc29bd33f9d6@310",
    variables: [
        {
            inputs: ["md"],
            value: (function(md){return(
                md`# D3 Zoomable Sunburst  a [sunburst diagram](/@mbostock/d3-sunburst), a radial orientation of D3’s [hierarchical partition layout](https://github.com/d3/d3-hierarchy/blob/master/README.md#partition)`
            )})
        },
        {
            name: "chart",
