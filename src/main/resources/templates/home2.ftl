...
<body class="hold-transition skin-blue sidebar-mini" ng-app="home">
<div class="wrapper">
                                ...
                                <ul class="menu">
                                    ...
                                    <li><!-- start message -->
                                        <a href="add.html" target="_blank">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="img/2.png" class="img-circle" alt="User Image">
                                            </div>
                                            <!-- Message title and timestamp -->
                                            <h4>
                                                Support Team
    ...
    <aside class="main-sidebar" ng-controller="NavbarCtrl">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="img/3.png" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview" ng-repeat="a1 in navbar">
                    <a href="#"><i class="fa fa-link"></i> <span>{{ a1.label }}</span>
                        <span class="pull-right-container" ng-if="a1.children.length>0">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu" ng-if="a1.children.length>0">
                        <li ng-repeat="a2 in a1.children"><a href="javascript:void(0)" class="myLeftMenu" data="add.html">{{ a2.label }}</a></li>
                        <#--<li><a href="javascript:void(0)" class="myLeftMenu" data="checkbox.html">点击是checkbox页面</a></li>-->
                        <#--<li><a href="javascript:void(0)" class="myLeftMenu" data="userList.html">我是userList</a></li>-->
                    </ul>
                </li>

                <#--<li class="header text-center panel panel-primary"><span class="fa-lg ">我就是系统标题</span></li>-->
                <!-- Optionally, you can add icons to the links -->
              ...
              <#--</span>-->
                    ...
                    <#--<ul class="treeview-menu">-->
                        <#--<li><a href="javascript:void(0)" class="myLeftMenu" data="add.html">我是add</a></li>-->
                        <#--<li><a href="javascript:void(0)" class="myLeftMenu" data="checkbox.html">点击是checkbox页面</a></li>-->
                        <#--<li><a href="javascript:void(0)" class="myLeftMenu" data="userList.html">我是userList</a></li>-->
                    <#--</ul>-->
                <#--</li>-->
